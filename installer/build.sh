...
pkgbuild --root ROOT --identifier org.rti-zone.PegasusController_X2 --sign "$installer_signature" --scripts Scritps --version 1.0 PegasusController_X2.pkg
pkgutil --check-signature ./PegasusController_X2.pkg
else
pkgbuild --root ROOT --identifier org.rti-zone.PegasusController_X2 --scripts Scritps --version 1.0 PegasusController_X2.pkg
fi
